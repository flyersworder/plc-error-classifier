...
CODE_GENERATION_PATTERNS: list[ErrorPattern] = [
    ...
    ErrorPattern(
        ...
        severity="blocking",
        complexity="trivial",
        error_message='No interface defined in "{pou_name}" POU',
        category="missing_interface",
        description="POU is missing the interface element entirely",
        variations=2,
    ),
    # Moderate (10 cases)
    ErrorPattern(
    ...
    ErrorPattern(
        id="codegen_005",
        name="connector_not_linked",
        stage="code_generation",
        severity="blocking",
        complexity="moderate",
        error_message='Connector "{name}" not linked in "{pou_name}" POU',
        category="connector_error",
        description="FBD/LD connector element has no matching continuation",
        variations=2,
    ),
    ErrorPattern(
        id="codegen_006",
        name="variable_not_connected",
        stage="code_generation",
        severity="blocking",
        complexity="moderate",
        error_message='Variable "{name}" output not connected in "{pou_name}" POU',
        category="connection_error",
        description="Variable block in FBD has unconnected output",
        variations=2,
    ),
    ErrorPattern(
        id="codegen_007",
        ...
        severity="blocking",
        complexity="moderate",
        error_message="TypeError: cannot connect",
        category="connection_error",
        description="FBD connection between incompatible types",
        variations=2,
    ),
    ErrorPattern(
        id="codegen_008",
        ...
        severity="blocking",
        complexity="moderate",
        error_message='Duplicate connection to input "{name}"',
        category="connection_error",
        description="Multiple connections to same FBD input pin",
        variations=1,
    ),
    # Complex (7 cases)
    ErrorPattern(
    ...
    ErrorPattern(
        id="codegen_010",
        name="sfc_action_not_defined",
        stage="code_generation",
        severity="blocking",
        complexity="complex",
        error_message='Action "{name}" not defined in SFC',
        category="sfc_error",
        description="SFC step references undefined action block",
        variations=2,
    ),
    ErrorPattern(
        id="codegen_011",
        name="fbd_execution_order",
        stage="code_generation",
        severity="blocking",
        complexity="complex",
        error_message="Unable to determine execution order in FBD",
        category="fbd_error",
        description="FBD blocks form loop or ambiguous execution order",
        variations=2,
    ),
    ErrorPattern(
        id="codegen_012",
...
IEC_COMPILATION_PATTERNS: list[ErrorPattern] = [
    ...
    ErrorPattern(
        ...
        severity="blocking",
        complexity="trivial",
        error_message="Undeclared identifier",
    ...
    ErrorPattern(
        ...
        category="duplicate",
        description="Variable or POU declared more than once",
        variations=1,
    ),
    ErrorPattern(
        id="iec_009",
    ...
    ErrorPattern(
        ...
        severity="blocking",
        complexity="moderate",
        error_message="Undeclared structured variable, or non-existent field",
    ...
    ErrorPattern(
        ...
        severity="blocking",
        complexity="moderate",
        error_message="Type mismatch for parameter",
        category="function_error",
        description="Function called with wrong parameter type",
        variations=2,
    ),
    ErrorPattern(
        id="iec_014",
    ...
    ErrorPattern(
        ...
        category="function_error",
        description="Required function parameter not provided",
        variations=2,
    ),
    ErrorPattern(
        id="iec_016",
    ...
    ErrorPattern(
        id="iec_017",
        name="enum_value_not_found",
        stage="iec_compilation",
        severity="blocking",
        complexity="moderate",
        error_message="Enumeration value not declared",
        category="enum_error",
        description="Using undefined enum value",
        variations=2,
    ),
    ErrorPattern(
        id="iec_018",
        ...
        description="String literal longer than declared STRING size",
        variations=2,
    ),
    ErrorPattern(
        id="iec_019",
        name="incompatible_fb_assignment",
        stage="iec_compilation",
        severity="blocking",
        complexity="moderate",
        error_message="Cannot assign function block instances",
        category="fb_error",
        description="Attempting to assign one FB instance to another",
        variations=2,
    ),
    # Complex (7 cases)
    ErrorPattern(
    ...
    ErrorPattern(
        ...
        severity="blocking",
        complexity="complex",
        error_message="Ambiguous function call",
        category="overload_error",
        description="Multiple function overloads match call signature",
        variations=2,
    ),
    ErrorPattern(
        id="iec_022",
        name="recursive_fb_instantiation",
        stage="iec_compilation",
        severity="blocking",
        complexity="complex",
        error_message="Recursive instantiation",
        category="fb_error",
        description="Function block creates instance of itself (directly or indirectly)",
        variations=1,
    ),
    ErrorPattern(
        id="iec_023",
        name="complex_expression_type",
        stage="iec_compilation",
        severity="blocking",
        complexity="complex",
        error_message="Unable to determine type of expression",
        category="type_inference",
        description="Complex expression with ambiguous or unresolvable type",
        variations=2,
    ),
]
